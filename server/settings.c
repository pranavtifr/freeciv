  ...
  if (S_S_RUNNING == server_state()) {
    ...
    if (game.info.turn == 0) {
      ...
      if (timeout != -1) {
        ...
        game.info.seconds_to_phasedone = game.info.timeout;
      }
    }
    send_game_info(NULL);
  }
...
static struct setting settings[] = {
  ...
  GEN_INT("globalwarming_percent", game.server.global_warming_percent,
           ...
           N_("This is a mutiplier for the rate of accumulation of global "
              "warming."), NULL, NULL, GAME_MIN_GLOBAL_WARMING_PERCENT,
  ...
  GEN_INT("nuclearwinter_percent", game.server.nuclear_winter_percent,
           ...
           N_("This is a mutiplier for the rate of accumulation of nuclear "
              "winter."), NULL, NULL, GAME_MIN_NUCLEAR_WINTER_PERCENT,
 ...
 GEN_INT("techlossrestore", game.server.techloss_restore,
  ...
  GEN_INT("diplchance_steal", game.server.diplchance_steal,
          ...
          NULL, NULL,
          GAME_MIN_DIPLCHANCE_STEAL, GAME_MAX_DIPLCHANCE_STEAL, GAME_DEFAULT_DIPLCHANCE_STEAL)
